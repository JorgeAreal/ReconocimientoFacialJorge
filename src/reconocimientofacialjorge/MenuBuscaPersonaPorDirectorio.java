 ...
 */
public class MenuBuscaPersonaPorDirectorio extends JFrame {
    ...
    public MenuBuscaPersonaPorDirectorio(String nombre) {
        this.nombre = nombre;
    ...
    private void configurarFrame(){
        setTitle("Buscar Persona dentro de un Directorio");
    ...
    private void colocarElementos() {
        ...
        InterfazGrafica.calcularNuevoTamanioImagen("recursos/face_recognition.jpg", fotoAdorno, 20, 20, 230, 230);
        
        textoInstrucciones = new JLabel();
        InterfazGrafica.calcularNuevoTamanioImagen("recursos/textos/texto_direccion_individual.png", textoInstrucciones, 266, 0, 300, 230);

        // Boton de seleccionar archivo
        selectorFotoButton = new JLabel();
        InterfazGrafica.calcularNuevoTamanioImagen("recursos/botones/buscar_directorio_button.jpg", selectorFotoButton, 320, 190, 200, 50);
    ...
    private void gestionarFuncionalidadesBotones() {
        ...
        selectorFotoButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                ...
                InterfazGrafica.calcularNuevoTamanioImagen("recursos/botones/buscar_directorio_button_hover.jpg", selectorFotoButton, 320, 190, 200, 50);
            }
        ...
        botonEjecutar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (!imagenSeleccionada.isEmpty() && ConexionBBDD.comprobarConexionTabla("conocidos")) {
                    ...
                    IntegracionPython.ejecutarBuscarIndividual(imagenSeleccionada, nombre, "directorio");
                    ...
                    JOptionPane.showMessageDialog(null, "¡Debes rbuscar el directorio primero!", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
    }
    ...
    private void seleccionarDirectorio() {
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            imagenSeleccionada = selectorDirectorio.getSelectedFile().getPath();
            JOptionPane.showMessageDialog(null, "Directorio seleccionado: " + imagenSeleccionada);
